				...
				<div class="todou_huken"><h3>青森県</h3></div>
					<div class="section">
						...
						<ul>
							...
							<li><span class="train">塗料販売店</span></li>
							<li>〒039-1121 青森県八戸市卸センター１丁目８－８</li>
							<li>
								<div>
									<span class="icon">■店舗情報</span>
									<p>ショールームあり/全色サンプル/壁紙全サンプルあり</p>
								</div>
							</li>
						</ul>
					...
					<div class="section">
						...
						<ul>
							...
							<li>
								<div>
									<span class="icon">■店舗情報</span>
									<p>ショールームあり/全色サンプル/壁紙全サンプルあり/ペイントの店舗販売あり</p>
								</div>
							</li>
						</ul>
				...
				<div class="todou_huken"><h3>愛媛県</h3></div>
					<div class="section">
						...
						<ul>
							...
							<li><span class="train">壁紙・塗料卸</span></li>
							<li>〒791-8015 愛媛県松山市中央2-42-1</li>
							<li>
								<div>
									<span class="icon">■店舗情報</span>
				...
				<div class="todou_huken"><h3>福岡県</h3></div>
					<div class="section">
						...
						<ul>
							...
							<li><span class="train">インテリアショップ</span></li>
							<li>〒819-0166 福岡県福岡市西区横浜１－２３－７</li>
							<li>
								<div>
									<span class="icon">■店舗情報</span>
									<p>ショールームあり/全色サンプル/壁紙全サンプルあり/ペイントの店舗販売あり</p>
