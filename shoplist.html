...
<div id="wrapper">
    ...
    include_once $path . 'lib/sideicon.php';
    ?>

	<div class="container">
		<div class="pathArea">
			<ol class="clearfix">
				<li class="ml0"><a class="ml0" href="./">HOME</a></li><!--
				--><li class="ended"><a href="javascript:void(0)">SHOPLIST</a></li>
			</ol>
		</div>
		<div class="contentsWhole">
			<div class="h2">
				<h2><img src="./images/shoplist/h2_shoplist.jpg"></h2>
			</div>
			<div class="contentsInner">
				<div id="shoplist">
				<!-- ストッキスト -->
				<div>
					<span>Brand Stockist：</span>
						<p>ショールームがございます。全色サンプル・壁紙全サンプルをご覧いただけます。</p>
						<p>その場での塗料の店頭販売も行っています。（在庫状況によります。）</p>
						<p>業者様への卸売販売も行っています。</p><br>
					<span>Brand Promoter及び、Holder:</span>
						<p>
						直接、施工に関するご相談をしていただくことができます。
						</p>
				</div><br>
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							<li><h4><a href="https://goodnews-ks.com/" target="_blank" rel="noopener noreferrer">有限会社グッドニュース</a></h4></li>
							<li><span style="font-size:12px">インテリアショップ・注文住宅</span></li>
							<li style="font-size:12px">〒071-1437 北海道上川郡東川町東７号北７線</li>
						</ul>
				</div>
				<div class="todou_content">
					<div class="section">
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							<li><h4><a href="https://sasaki-toryo.co.jp/" target="_blank" rel="noopener noreferrer">佐々木塗料株式会社（カラーワークス青い森）</a></h4></li>
							<li><span style="font-size:12px">塗料販売店</span></li>
							<li style="font-size:12px">〒039-1121 青森県八戸市卸センター１丁目８－８</li>
							<li>
								<div>
									<span class="icon" style="font-size:12px">■店舗情報</span>
									<p style="font-size:12px">ショールームあり/全色サンプル/壁紙全サンプルあり</p>
								</div>
							</li>
						</ul>
				</div>
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							<li><h4><a href="https://hot-living.com/" target="_blank" rel="noopener noreferrer">ほっとリビング・株式会社アポロガス</a></h4></li>
							<li><span style="font-size:12px">工務店・リフォーム</span></li>
							<li style="font-size:12px">〒960-8252 福島県福島市御山字中川原８４－１</li>
						</ul>
				</div>
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							<li><h4><a href="http://www.hoshiken.com/" target="_blank" rel="noopener noreferrer">株式会社ホシケン</a></h4></li>
							<li><span style="font-size:12px">インテリア総合商社</span></li>
							<li style="font-size:12px">〒371-0016 群馬県前橋市城東町５－６５７－１８</li>
						</ul>
				</div>
				<div class="todou_content">
					<div class="section">
				...
				<div class="todou_content">
					<div class="section">
						<ul>
							<li class="section_1">Brand Promoter</li>
						</ul>
					</div>
						<ul>
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							<li><h4><a href="http://www.jukobo.jp/" target="_blank" rel="noopener noreferrer">株式会社住工房スタイル</a></h4></li>
							<li><span style="font-size:12px">注文住宅</span></li>
							<li style="font-size:12px">〒270-1516 千葉県印旛郡栄町安食２４２１－８７</li>
						</ul>
				</div>
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							...
							<li><span style="font-size:12px">カフェ・内装業</span></li>
							<li style="font-size:12px">〒166-0012 東京都杉並区和田３－５７－５ １Ｆ</li>
						</ul>
 					</div>
					 <div class="todou_content">
					<div class="section">
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							<li><h4><a href="http://www.atelier-ensemble.net/" target="_blank" rel="noopener noreferrer">ATELIER ENSEMBLE</a></h4></li>
							<li><span style="font-size:12px">設計・施工</span></li>
							<li style="font-size:12px">〒248-0027 神奈川県鎌倉市笛田５－４１－４９</li>
						</ul>
				</div>
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							...
							<li><span style="font-size:12px">英国アンティーク専門店</span></li>
							<li style="font-size:12px">〒247-0056 神奈川県鎌倉市大船２－１６－２湘南ファーストビル１Ｆ</li>
						</ul>
				</div>
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							<li><h4><a href="https://uenojyuken.co.jp/" target="_blank" rel="noopener noreferrer">上野住宅建材株式会社</a></h4></li>
							<li><span style="font-size:12px">インテリア総合商社</span></li>
							<li style="font-size:12px">〒954-0111 新潟県見附市今町６－２８－３１</li>
						</ul>
				</div>
				<div class="todou_content">
					<div class="section">
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							<li><h4><a href="https://www.yam21.com/" target="_blank" rel="noopener noreferrer">株式会社ヤマダタッケン</a></h4></li>
							<li><span style="font-size:12px">注文住宅</span></li>
							<li style="font-size:12px">〒921-8164 石川県金沢市久安１－４１１</li>
							<li>
								<div>
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							<li><h4><a href="https://www.ncc-nice.com/" target="_blank" rel="noopener noreferrer">NCC株式会社</a></h4></li>
							<li><span style="font-size:12px">塗料販売店</span></li>
							<li style="font-size:12px">〒399-4431 長野県伊那市西春上島２４３１</li>
						</ul>
					</div>
				<div class="todou_content">
					<div class="section">
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							<li><h4><a href="https://www.happy-deco-house.com/" target="_blank" rel="noopener noreferrer">株式会社ナチュラルライフ</a></h4></li>
							<li><span style="font-size:12px">注文住宅・雑貨販売</span></li>
							<li style="font-size:12px">〒410-0312 静岡県沼津市市原１４１４－１第２長沢ビル１０１</li>
						</ul>
				</div>
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							...
							<li><span style="font-size:12px">設計・施工</span></li>
							<li style="font-size:12px">〒416-0909 静岡県富士宮市松岡松岡1805１８０５－１６</li>
						</ul>
				</div>
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							...
							<li><span style="font-size:12px">注文住宅</span></li>
							<li style="font-size:12px">〒458-0921 愛知県名古屋市緑区桶狭間清水山１３０６－１</li>
						</ul>
					</div>
				<div class="todou_content">
					<div class="section">
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							<li><h4><a href="https://castlee.jp/" target="_blank" rel="noopener noreferrer">ホームデザインキャスリー株式会社</a></h4></li>
							<li><span style="font-size:12px">注文住宅</span></li>
							<li style="font-size:12px">〒513-0809 三重県鈴鹿市西条４丁目８０</li>
						</ul>
				</div>
					...
					<div class="section">
						...
						<ul>
							...
							<li>
								<div>
									<span style="font-size:12px">■店舗情報</span>
									<p style="font-size:12px">ショールームあり/全色サンプル/壁紙全サンプルあり/ペイントの店舗販売あり</p>
								</div>
							</li>
						</ul>
				</div>
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							<li><h4><a href="https://interior-koyo.com/" target="_blank" rel="noopener noreferrer">株式会社インテリア紅葉</a></h4></li>
							<li><span style="font-size:12px">インテリアショップ</span></li>
							<li style="font-size:12px">〒755-0058 山口県宇部市松原新堀１１３８－１</li>
						</ul>
					</div>
					...
					<div class="section">
						...
						<ul>
							...
							<li>
								<div>
									<span style="font-size:12px">■店舗情報</span>
									<p style="font-size:12px">四国４県にショールームあり/全色サンプル/壁紙全サンプル/サンプルポット全色購入可能</p>
								</div>
							</li>
						</ul>
				</div>
				...
				<div class="todou_content">
					<div class="section">
						...
						<ul>
							<li><h4><a href="https://www.kiful.com/" target="_blank" rel="noopener noreferrer">木本家具工芸社/KifuL</a></h4></li>
							<li><span style="font-size:12px">インテリアショップ</span></li>
							<li style="font-size:12px">〒819-0166 福岡県福岡市西区横浜１－２３－７</li>
							<li>
								<div>
									<span style="font-size:12px">■店舗情報</span>
									<p style="font-size:12px">ショールームあり/全色サンプル/壁紙全サンプルあり/ペイントの店舗販売あり</p>
	...
	<div class="footer">
		...
		<!--<a id="footer_content" name="footer_content"></a>-->
		<div class="acc clearfix">
		<div id="footer-accordion" class="col-xs-12 col-sm-4 col-md-3 col-lg-5 vertical-center">
			
			<div class="footer_section links panel">
				<h3 data-toggle="collapse" data-parent="#footer-accordion" data-target="#contact-us" class="collapsed">CONTACT</h3>
				<ul id="contact-us" class="collapse">
					<li><a href="./catalog/">資料・サンプル請求</a></li>
					<li><a href="./contact/">お問い合わせ</a></li>
					<li><a href="./question/">Q&A</a></li>
				</ul>
			</div>
			<div class="footer_section panel">
				<h3 class="nonArrow"><a href="sitemap.html">SITEMAP</a></h3>
			</div>			
		</div>
		</div>
		<div class="scrollTop">
			<div id="pagetop">
			    <a href="#top">
			        <img src="./images/common/pagetop.png" alt="このページの先頭へ" name="pagetopbtn" id="pagetopbtn" width="75" height="41">
		        </a>
		    </div>
	    </div>
		<div class="ftLogo">
			<p><img src="./images/common/ft_logo.png"></p>
			<p class="mt10 mb10">www.farrow-ball.jp</p>
			<p class="eu">Operated by Colorworks</p>
			<p class="treatText mt10">Farrow&Ball製品の日本国内の販売及びお問い合わせ等は<br>日本総代理店である株式会社カラーワークスが行っております。</p>
		</div>
		<div class="linkColorWorks">
			<ul class="clearfix">
				<li class="official"><a href="http://colorworks.co.jp/" target="_blank"><img src="./images/common/ft_link01.gif" alt="カラーワークスオフィシャルウェブサイト"></a></li>
				<li><a href="http://paint-shop.colorworks.co.jp/" target="_blank"><img src="./images/common/ft_link02.gif" alt="カラーワークスオンラインショップ"></a></li>
			</ul>
		</div>
		<p class="copyright eu">Copyright © 2015 Farrow & Ball</p>
	</div>
